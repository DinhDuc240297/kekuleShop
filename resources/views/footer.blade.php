			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Mọi thắc mắc xin liên hệ về số điện thoại 0971272297
					</p>
			...
			<div class="p-t-40">
				...
				<p class="stext-107 cl6 txt-center">
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						Copyright &copy;<script>document.write(new Date().getFullYear());</script>  with <i class="fa fa-heart-o" aria-hidden="true"></i>
						<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							...
							<span class="mtext-106 cl2">
								Giá <span class="cart-price-product">200.000 vnđ</span>
							</span>

							<p class="stext-102 cl3 p-t-23">
								Mẫu nam 2018 giúp bạn phong cách hơn trong từng hoạt động. 
								Kiểu dáng sành điều, thon gọn giúp bạn tự tin trước đám đông.
							</p>
							...
							<div class="flex-w flex-m p-l-100 p-t-40 respon7">
								<div class="flex-m bor9 p-r-10 m-r-11">
									<a href="#" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 js-addwish-detail tooltip100" data-tooltip="Add to Wishlist">
										<i class="zmdi zmdi-favorite add-to-wish-size"></i>
									</a>
								</div>
